...
import { RotateCcw, Cpu, ArrowLeft, CheckCircle2, Play, Pause, Filter, Calendar, Volume2 } from "lucide-react";
        ...
        <div className="absolute top-4 left-4 z-20 w-80 bg-white/95 backdrop-blur-md p-5 rounded-2xl shadow-xl border border-slate-200/80 space-y-4 text-xs select-none max-h-[calc(100vh-100px)] overflow-y-auto">
          ...
          {(selectedEntityId === "hospitals" || selectedEntityId === "all") && (
            <div className="pt-3 border-t border-slate-200/80 space-y-3">
              ...
              {/* CARE Audio Guided Narration Cue Test */}
              <div className="pt-2 border-t border-slate-100 space-y-1.5">
                <label className="text-[10px] font-black uppercase tracking-widest text-emerald-800 flex items-center gap-1">
                  <Volume2 className="w-3 h-3 text-emerald-600" />
                  <span>CARE Audio Pilot Cues (Dev Test)</span>
                </label>
                <div className="grid grid-cols-2 gap-1 text-[10px] font-bold">
                  <button
                    ...
                    className="px-2 py-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-900 rounded border border-emerald-200 text-left"
                  >
                    [1] Intro Footprint
                  </button>
                  <button
                    onClick={() => {
                      setCareTypeFilter("tertiary");
                      const madurai = locations.find((l) => l.id === "hosp_madurai" || l.city === "Madurai");
                      if (madurai) setSelectedLocation(madurai);
                    }}
                    className="px-2 py-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-900 rounded border border-emerald-200 text-left"
                  >
                    [2] Origin Madurai
                  ...
                  <button
                    onClick={() => setCareTypeFilter("tertiary")}
                    className="px-2 py-1 bg-blue-50 hover:bg-blue-100 text-blue-900 rounded border border-blue-200 text-left"
                  >
                    [3] Tertiary (8)
                  </button>
                  <button
                  ...
                  <button
                    onClick={() => setCareTypeFilter("community")}
                    className="px-2 py-1 bg-sky-50 hover:bg-sky-100 text-sky-900 rounded border border-sky-200 text-left"
                  >
                    [5] Community (8)
                  </button>
                  <button
                    ...
                    className="px-2 py-1 bg-emerald-700 text-white rounded text-left font-black"
                  >
                    [6] Full Scale (24)
                  </button>
                </div>
