    ...
    subcategories: [
      {
        id: "domestic",
        name: "Domestic",
        tagline: "42 Domestic Dealer Cities across India",
        defaultScope: "state",
        primaryMetricKey: "dealersCount",
        secondaryMetricKeys: ["citiesCovered", "productsDistributed"],
        legendTitle: "Domestic Dealer Network (42 Cities)",
      },
      {
        id: "international",
        name: "International",
        ...
        legendTitle: "Global Distribution (160+ Countries)",
      },
    ],
    metrics: [
      { id: "nationalDealersCount", label: "Domestic Dealers (42)" },
      { id: "exportCountriesCount", label: "Export Nations (160+)" },
