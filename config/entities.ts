  ...
  aurolab: {
    ...
    subcategories: [
      ...
      },
      {
        id: "international",
        name: "International",
        tagline: "Export distribution across 83 International Clients",
        defaultScope: "world",
        primaryMetricKey: "exportCountries",
        secondaryMetricKeys: ["globalDealers", "iolsExported"],
        legendTitle: "Global Distribution (83 International Clients)",
      },
    ],
    metrics: [
      { id: "nationalDealersCount", label: "Domestic Dealers (42)" },
      { id: "exportCountriesCount", label: "International Clients (83)" },
