...
export function SearchModal({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-start justify-center pt-20 px-4 animate-in fade-in duration-200">
          ...
          {!cleanQuery ? (
            ...
            <>
              ...
              {filteredStates.length > 0 && (
                <div>
                  <h4 className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest px-3 py-1">
                    States / Regions
                  </h4>
                  {filteredStates.map((st) => (
                    <button
                      ...
                      className="w-full text-left px-3 py-2 rounded-lg hover:bg-slate-800/80 flex items-center justify-between text-xs text-slate-200 group"
                    >
                ...
                <div>
                  ...
                  {filteredLocations.map((loc) => (
                    <button
                      ...
                      className="w-full text-left px-3 py-2.5 rounded-lg hover:bg-slate-800/80 flex items-start justify-between text-xs text-slate-200 group"
                    >
                      <div>
                      ...
                      <ArrowRight className="w-3.5 h-3.5 text-slate-500 group-hover:text-white shrink-0 mt-1" />
                    </button>
                  ))}
                </div>
              )}
