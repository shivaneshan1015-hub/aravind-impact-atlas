...
export function ContextPanel({
  ...
  const activeStateAgg = stateAggregations.find(
    (s) => s.stateName === selectedState
  );

  return (
    <aside className="w-72 md:w-80 bg-slate-950/95 border-l border-slate-800/80 flex flex-col shrink-0 z-20 select-none overflow-y-auto">
      {/* Header */}
            ...
            <div>
              <div
                ...
                style={{
                  ...
                  color: entityConfig.colorLight,
                  border: `1px solid ${entityConfig.color}40`,
                }}
              >
              ...
              <div className="space-y-1.5 max-h-80 overflow-y-auto pr-1">
                {locationsInSelectedState.map((loc) => (
                  <button
                    ...
                    className="w-full text-left p-2.5 rounded-md bg-slate-900/60 border border-slate-800 hover:border-slate-700 hover:bg-slate-850 transition-all flex items-center justify-between group"
                  >
                    <div>
